...
struct Empty {
  ...
  struct Policies {
    ...
    static Traversal<Empty>::graph_t * startOn(SgNode *) { return NULL; }
    static Traversal<Empty>::graph_t * getSubgraph(SgNode * node, Traversal<Empty>::graph_t * graph) { return graph; }
  };
