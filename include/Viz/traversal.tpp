...
template <class UserTraversal>
Traversal<UserTraversal>::graph_t::~graph_t() {
  typename std::map<std::string, graph_t *>::iterator it_child;
...
template <class UserTraversal>
std::string Traversal<UserTraversal>::getNodeName(SgNode * node) {
